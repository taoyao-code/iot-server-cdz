...
func StartOutbound(dbpool *pgxpool.Pool, throttleMs int, retryMax int, deadRetentionDays int, appm *metrics.AppMetrics, sess *session.Manager) (context.CancelFunc, *outbound.Worker) {
